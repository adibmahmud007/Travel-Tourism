...
public class CheckHotels extends JFrame implements Runnable{
    Thread t1;
    JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,caption;
    JLabel[] label=new JLabel[]{l1,l2,l3,l4,l5,l6,l7,l8,l9,l10};
    String[] text=new String[]{"JW Marriot Hotel","Six Seasons Hotel","Intercontinental Hotel","Pan Pacific Sonargaon","Grand Sultan Hotel","Raddisson Blue","Rennaissance Hotel","Le Meridien Dhaka","Crown Plaza","Sea Pearl Resort and Spa"};
     public void run(){
         try{
             for(int i=0;i<=9;i++){
